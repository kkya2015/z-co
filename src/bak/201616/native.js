...
var app = (function(global) {
  ...
  $L.prompt = function(message, title, btnCaptions, inputValue, inputTpye, callback) {
    ...
    var setting = {
      ...
      // callback = callback || function(){}
    $L.executeNativeJS(['window', 'prompt'], setting, function(Tips, error) {
      $L.isFunction(callback) && callback.call(global, Tips.buttonIndex, Tips.text, error);
    });
  }
  return $L;
}(this));
